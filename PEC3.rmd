...
- Vector llamado *habitat* es una variable tipo factor que describe el tipo de habitat y año de recogida de la información.
...
```{r echo=F}
tab.1_cap<-table_nums(name=paste0("tab",ind.tabla))
piosphere$habitat %>% head() %>% kable(caption = paste0(tab.1_cap,"Primeros seis elementos de Vector habitat")) %>% kable_styling()
ind.tabla <- increment(ind.tabla,1)
```

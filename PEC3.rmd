...
- Data frame que se llama *veg* que tiene la información de las especies vegetales. Cada una de las filas se corresponde a los datos de las piosferas elegidas. Tenemos 378 piosferas y 87 tipos de plantas.
- Data frame que se llama *traits* que tiene la información de las características de las plantas. Cada una de las filas se corresponde a los valores de las columnas del data frame *veg*. Es decir en este data frame tendremos 87 filas y 21 características
- Data frame que se llama *env* que contiene la información de variables medioambientales relativas a las 378 fincas que se han estudiado. Se han recopilado 25 variables
- Vector llamado *habitat* que describe el número de habitats/año de cada una de las fincas analizadas.
...
data("piosphere")
help(piosphere)
length(piosphere$traits)
colnames(piosphere$traits)

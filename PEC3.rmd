...
Vamos a analizar si hay diferencias entre las siguientes características de las piosferas según el tipo de habitat en el que se encuentran.
...
```{r}
sapply(colnames(piosphere$env),FUN=function(variable){shapiro.test(log(piosphere$env[,variable]))})
library(MASS)

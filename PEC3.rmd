...
#Boxplot en log
logDboxplot <- ggplot(data=traits, aes(x=log(traits$diaspore.length))) + 
...
descdist(piosphere$env$GrazInt, discrete = FALSE)
hist(piosphere$env$GrazInt)
  fit.weibull <- fitdist(piosphere$env$GrazInt, "weibull")
...
seleccion_muestras[,sapply(seleccion_muestras,FUN=function(muestra){

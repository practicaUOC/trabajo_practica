...
- Mostrar el porcentaje de especies que tienen datos en cada una de las piosferas
...
compareGroups::compareGroups(formula=habitat~GrazInt,method = 4,data=df) %>% compareGroups::createTable(show.p.mul = T) %>% compareGroups::export2md()
```
